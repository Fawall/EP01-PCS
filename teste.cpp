...
void testeEntradasESaidas()
{
    ...
    cout << "Saida usuario 3: " << usuario3->sair(new Data(12, 12, 27, 5, 1, 2024)) << endl
         << endl;
    ...
    cout << "Entrada antes da primeira entrada do usuario 5: " << usuario5->entrar(new Data(3, 12, 27, 5, 1, 2024)) << endl
         << endl;
...
void testeEntradaESaidaCatraca()
{
    ...
    cout << "Usuario 3: " << c->entrar(3, new Data(2, 1, 1, 4, 1, 2024)) << endl
         << endl;
...
void testeManual()
{
    ...
    Usuario *u1 = new Usuario(1, "Maria", 10);
    Usuario *u2 = new Usuario(2, "Joao", 10);

    bool verificaUsuario = g->adicionar(u1);
    bool verificaUsuario2 = g->adicionar(u2);
    ...
    bool verificaEntrar = c->entrar(2, new Data(10, 0, 0, 28, 9, 2024));
    if(verificaEntrar != true){
        cout << "Catraca Entrada travada. id 2" <<endl<<endl;
    }
    else{
        cout << "Catraca Entrada abriu. id 2" <<endl<<endl;
    }

    verificaEntrar  = c->entrar(1, new Data(10, 0, 0, 28, 9, 2024));

    if(verificaEntrar != true){
        cout << "Catraca Entrada travada. id 1" <<endl<<endl;
    }
    else{
        cout << "Catraca entrada abriu. id 1" <<endl<<endl;
    }

    bool verificaSair = c->sair(1, new Data(13, 0, 0,28,9,2024));
    if(verificaSair != true){
        cout << "Catraca saida travada. id 1" <<endl<<endl;
    }
    else{
        cout << "Catraca saida abriu. id 1" <<endl<<endl;
    }

    verificaSair = c->sair(2, new Data(13, 5, 0, 28, 9, 2024));

    if(verificaSair != true){
        cout << "Catraca saida travada. id 2" <<endl<<endl;
    }
    else{
        cout << "Catraca saida abriu. id 2" <<endl<<endl;
    }

    verificaEntrar = c->entrar(2, new Data(14, 0 , 0, 28, 9, 2024));
    if(verificaEntrar != true){
        cout << "Catraca Entrada travada. id 2  LINHA 315" <<endl<<endl;
    }
    else{
        cout << "Catraca Entrada abriu. id 2 LINHA 315" <<endl<<endl;
    }


    verificaSair = c->sair(1, new Data(18, 10, 0, 28, 9, 2024));
    if(verificaSair != true){
        cout << "Catraca Entrada travada. id 1 LINHA 324" <<endl<<endl;
    }
    else{
        cout << "Catraca Entrada abriu. id 1 LINHA 324" <<endl<<endl;
    }

    verificaEntrar = u1->registrarEntradaManual(new Data(14, 30, 0, 28, 9, 2024));
    
    if(verificaEntrar != true){
        cout << "Erro ao registrar entrada manual" <<endl<<endl;
    }
    else{
        cout << "Entrada manual registrada. id 1" <<endl<<endl;
    }

    verificaSair = c->sair(1,new Data(18, 15, 0, 28, 9, 2024));
    if(verificaSair != true){
        cout << "Erro ao registrar saida " <<endl<<endl;
    }
    else{
        cout << "Saida registrada. id 1" <<endl<<endl;
    }

    verificaSair =  c->sair(2,new Data(18,18,0,28,9,2024));
    if(verificaSair != true){
        cout << "Erro ao registrar saida id 2" <<endl<<endl;
    }
    else{
        cout << "Saida registrada. id 2" <<endl<<endl;
    }

    int horasTrabalhadas1 = u1->getHorasTrabalhadas(9, 2024);
    int horasTrabalhadas2 = u2->getHorasTrabalhadas(9, 2024);

    cout << "Horas trabalhadas usuario 1: " << horasTrabalhadas1 <<endl;
    cout << "Horas trabalhadas usuario 2: " << horasTrabalhadas2 <<endl;
